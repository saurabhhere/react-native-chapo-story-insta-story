    ...
    const [content, setContent] = useState(
        stories.map((x) => {
            return {
                ...
                tags: x.tags,
                tagsStyling: x.tagsStyling,
                restaurantName: x.restaurantName,
                restaurantNameStyling: x.restaurantNameStyling,
                foodName: x.foodName,
                foodNameStyling: x.foodNameStyling,
                // position: x.position ? x.position : 'bottom', 
                finish: 0
            }
        }));
    ...
    return (
        ...
        >
            ...
            <View style={{flexDirection: 'column', flex: 1,}}>
                ...
                <View style={{flex: 1}}>
                    <Text style={content[current].restaurantNameStyling}>{content[current].restaurantName}</Text>
                    <Text style={content[current].foodNameStyling}>{content[current].foodName}</Text>
                    <View style={{flexDirection: 'row'}}>
                <View style={{...styles.tagsContainer, ...content[current].tagsStyling}}>
                    {content[current].tags && content[current].tags.map((t, index) => {
                        return <View style={styles.tag}>
                                <Emoji style={styles.tagEmoji} name={content[current].tags[index][0]} />
                                <Text style={styles.tagText}>{content[current].tags[index][1]}</Text>
                            </View>
                    })}
                </View>
                </View>
